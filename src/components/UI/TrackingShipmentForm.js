...
const TrackingShipmentForm = () => {
  ...
  return (
    <div className="tracking-form">
      <p>{t("SHIPMENT_TRACKING.TRACK_YOUR_SHIPMENT")}</p>
      <h3>{t("SHIPMENT_TRACKING.ENTER_TRACKING_NUMBER")}</h3>
      <div className="formContainre">
...
export default TrackingShipmentForm;
